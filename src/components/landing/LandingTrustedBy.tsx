          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
              <img 
                ...
                alt="UpGrowth" 
                className="h-10 md:h-12 w-auto object-contain transition-all hover:scale-105 grayscale hover:grayscale-0 opacity-70 hover:opacity-100"
              />
              <img 
                src="https://harmless-tapir-303.convex.cloud/api/storage/360ad36b-e195-467f-80b4-05af3785761f" 
                alt="UpGrowth Connect" 
                className="h-8 md:h-10 w-auto object-contain transition-all hover:scale-105 grayscale hover:grayscale-0 opacity-70 hover:opacity-100"
              />
              <img 
                src="https://harmless-tapir-303.convex.cloud/api/storage/ef75208c-7736-4b74-b7f4-a8a8aa9cc483" 
                alt="FA Management Solutions" 
                className="h-32 md:h-40 w-auto object-contain transition-all hover:scale-105 grayscale hover:grayscale-0 opacity-70 hover:opacity-100"
              />
            </div>
          </div>
        </section>
